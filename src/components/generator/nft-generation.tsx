            ...
            {networks.map((network) => (
              <motion.div
                ...
                className={`bg-zinc-900 border ${
                  selectedNetwork === network.id ? "border-purple-500" : "border-zinc-800"
        ...
        {selectedNetwork && (
          <div className="text-center">
            <Link
              ...
              className="inline-block bg-purple-500 hover:bg-purple-600 text-white font-medium px-8 py-3 rounded-lg transition-colors"
            >
              Continue
            </Link>
          </div>
